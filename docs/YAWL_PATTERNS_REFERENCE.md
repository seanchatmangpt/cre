...
This document provides detailed documentation for all 43 YAWL (Yet Another Workflow Language) workflow patterns implemented in the CRE framework. The patterns are categorized into seven groups based on their functionality and complexity.
