...
- [Workflow and Process Mining Research Papers - Comprehensive Summaries](#workflow-and-process-mining-research-papers---comprehensive-summaries)
  - [Table of Contents](#table-of-contents)
  - [1. Workflow Patterns (2003)](#1-workflow-patterns-2003)
  - [2. YAWL: Yet Another Workflow Language (2005)](#2-yawl-yet-another-workflow-language-2005)
  - [3. Workflow Mining: Discovering Process Models (2001)](#3-workflow-mining-discovering-process-models-2001)
  - [4. Verification of Workflow Nets (1997)](#4-verification-of-workflow-nets-1997)
  - [5. Fundamentals of Control Flow in Workflows (2000)](#5-fundamentals-of-control-flow-in-workflows-2000)
  - [6. Process Mining: Discovering Workflow Models (2001)](#6-process-mining-discovering-workflow-models-2001)
  - [7. Process Mining: Overview and Opportunities (2011)](#7-process-mining-overview-and-opportunities-2011)
  - [8. Process Mining Manifesto (2011)](#8-process-mining-manifesto-2011)
  - [9. Tutorial: Models, Systems, and Standards Workflow (2004)](#9-tutorial-models-systems-and-standards-workflow-2004)
  - [10. Process Mining Research Agenda (2003)](#10-process-mining-research-agenda-2003)
  - [11. YAWL: Design and Implementation (2004)](#11-yawl-design-and-implementation-2004)
  - [12. Workflow Exception Patterns (2008)](#12-workflow-exception-patterns-2008)
  - [13. Workflow Modeling Using Proclets (2000)](#13-workflow-modeling-using-proclets-2000)
  - [14. P2P Approach to Interorganizational Workflows (2000)](#14-p2p-approach-to-interorganizational-workflows-2000)
  - [15. Diagnosing Workflow Processes (Woflan) (2001)](#15-diagnosing-workflow-processes-woflan-2001)
  - [16. Business Process Management Survey (2013)](#16-business-process-management-survey-2013)
  - [17. Business Process Simulation (2013)](#17-business-process-simulation-2013)
  - [18. Repairing Process Models (2011)](#18-repairing-process-models-2011)
  - [19. Verification of Business Processes Using Petri Nets (2000)](#19-verification-of-business-processes-using-petri-nets-2000)
  - [20. Rediscovering Workflow Models (2001)](#20-rediscovering-workflow-models-2001)
  - [21. Structural Characterizations of Sound Workflow Nets (1996)](#21-structural-characterizations-of-sound-workflow-nets-1996)
  - [22. Process Mining Manifesto (TU/e) (2011)](#22-process-mining-manifesto-tue-2011)
  - [23. Business Process Mining: Industrial Application (2007)](#23-business-process-mining-industrial-application-2007)
  - [24. Supporting Full BPM Lifecycle (2009)](#24-supporting-full-bpm-lifecycle-2009)
  - [25. Mining Process Models (Non-Free-Choice)](#25-mining-process-models-non-free-choice)
  - [26. Process Mining: Case Handling (2005)](#26-process-mining-case-handling-2005)
  - [27. Discovering Process Models from Empirical Data (2003)](#27-discovering-process-models-from-empirical-data-2003)
  - [28. Process Mining Tutorial (2012)](#28-process-mining-tutorial-2012)
  - [29. A Decade of BPM Conferences (2010)](#29-a-decade-of-bpm-conferences-2010)
  - [30. Foundations of Process Discovery (2019)](#30-foundations-of-process-discovery-2019)
  - [31. Conformance Checking with Uncertain Event Data (2020)](#31-conformance-checking-with-uncertain-event-data-2020)
  ...
  - [35. Application of Petri Nets in Workflow Management (1998)](#35-application-of-petri-nets-in-workflow-management-1998)
  - [36. YAWL: Design and Implementation (QUT) (2004)](#36-yawl-design-and-implementation-qut-2004)
  - [37. Soundness of Workflow Nets (2011)](#37-soundness-of-workflow-nets-2011)
  - [Summary by Category](#summary-by-category)
    - [Workflow Patterns](#workflow-patterns)
    - [YAWL System](#yawl-system)
    - [Process Mining Fundamentals](#process-mining-fundamentals)
    - [Petri Nets and Verification](#petri-nets-and-verification)
    - [Advanced Process Mining](#advanced-process-mining)
    - [Business Process Management](#business-process-management)
    - [Workflow Systems and Practice](#workflow-systems-and-practice)
    - [Advanced Workflow Concepts](#advanced-workflow-concepts)
  - [Cross-Reference to Workflow Patterns](#cross-reference-to-workflow-patterns)
    - [Basic Control Flow Patterns (1-5)](#basic-control-flow-patterns-1-5)
    - [Advanced Branching and Synchronization (6-10)](#advanced-branching-and-synchronization-6-10)
    - [Structural Patterns (11-17)](#structural-patterns-11-17)
    - [State-Based Patterns (18-20)](#state-based-patterns-18-20)
    - [Cancellation Patterns (21-22)](#cancellation-patterns-21-22)
  - [Key Researchers and Their Contributions](#key-researchers-and-their-contributions)
    - [Wil M.P. van der Aalst](#wil-mp-van-der-aalst)
    - [Arthur H.M. ter Hofstede](#arthur-hm-ter-hofstede)
    - [Others](#others)
  - [Tool References](#tool-references)
    - [Process Mining Tools](#process-mining-tools)
    - [Workflow/Verification Tools](#workflowverification-tools)
  - [Timeline of Major Developments](#timeline-of-major-developments)
